...
<section className="relative pb-10 overflow-hidden backdrop">
  ...
  <div className="relative z-10 container px-4 mx-auto">
    <div className="max-w-4xl pt-20">
      ...
      <h2 className="mt-8 mb-8 text-5xl lg:text-7xl text-white font-bold" data-config-id="header">Save On Your Auto Insurance</h2>
      ...
      <div className="lg:max-w-md">
        ...
        <div className="flex items-start py-4">
          ...
          <div className="max-w-sm">
            <h3 className="mb-2 text-xl leading-loose text-gray-600" data-config-id="header1"><b>Easy</b> Access To Multiple Rates</h3>
          </div>
        </div>
        <div className="flex items-start py-4">
          <div className="mr-5 text-gray-500">
